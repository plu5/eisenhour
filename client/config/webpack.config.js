      ...
      },
      {
        ...
        options: {
          ...
          plugins: () => [
            ...
            //  which in turn let's users customize the target behavior
            //  as per their needs.
            postcssNormalize(),
          ],
  ...
  return {
    ...
    resolve: {
      ...
      plugins: [
        ...
        // NOTE(plu5): commented this out because i want to be able to import
        //  things outside src (for custom components in user custom folder).
        // new ModuleScopePlugin(paths.appSrc, [paths.appPackageJson]),
      ],
    },
    resolveLoader: {
      plugins: [
        // Also related to Plug'n'Play, but this time it tells webpack to
        // load its loaders from the current package.
    ...
    module: {
      ...
      rules: [
        ...
        //     {
        //       options: {
        //         // TODO(plu5): eslint 7.1 broke compilation for me unless
        //         //  i specify this or comment out this whole block. obviously
        //         //  it is not ideal to hardcode my config file in here so
        //         //  i would like to fix this if possible.
        //         // config: 'c:/home/.eslintrc.js',
        //         // NOTE(plu5): changed cache location to not be local
        //         cache: process.env.NODE_PATH + '/.cache/eslint-loader',
        //         formatter: require.resolve('react-dev-utils/eslintFormatter'),
        //         eslintPath: require.resolve('eslint'),
        //         // NOTE(plu5): maybe change this. not had any issues so far
        //         //  though. i don’t really utilise this; I only use eslint for
        //         //  flycheck, not for cli checking when building the project.
        ...
        // },
        {
          ...
          oneOf: [
            ...
            // assets smaller than specified limit in bytes as data URLs
            // to avoid requests.
            ...
            {
              test: /\.(js|mjs|jsx|ts|tsx)$/,
              // why does it still compile fine with this commented out?!
              include: paths.appSrc,
              use: [{
                loader: require.resolve('echo-loader'),
              }, {
              ...
              options: {
                ...
                plugins: [
                  // NOTE(plu5): added by me, in order to resolve issues with
                  //  importing custom react components from outside src
                ...
                // NOTE(plu5): changed it to not be local.
                cacheDirectory: process.env.NODE_PATH + '/.cache/babel-loader',
            ...
            // features.
            {
              ...
              options: {
                ...
                // plu5: changed it to not be local.
                cacheDirectory: process.env.NODE_PATH + '/.cache/babel-loader',
                // See #6846 for context on why cacheCompression is disabled
                cacheCompression: false,
    ...
    plugins: [
      ...
      // files by default due to how webpack interprets its code. This is
      // a practical solution that requires the user to opt into importing
      // specific locales.
      // https://github.com/jmblog/how-to-optimize-momentjs-with-webpack
      // You can remove this if you don't use Moment.js:
      new webpack.IgnorePlugin(/^\.\/locale$/, /moment$/),
      // Generate a service worker script that will precache, and keep
      // up to date, the HTML & assets that are part of the webpack build.
      isEnvProduction &&
        new WorkboxWebpackPlugin.GenerateSW({
          ...
          navigateFallbackBlacklist: [
            ...
            // likely a route with query params (e.g. auth callbacks).
            new RegExp('/[^/?]+\\.[^/]+$'),
          ],
        }),
      ...
      useTypeScript &&
        new ForkTsCheckerWebpackPlugin({
          ...
          silent: true,
          // The formatter is invoked directly in WebpackDevServerUtils
          //  during development
